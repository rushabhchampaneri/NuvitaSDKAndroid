...
public class FireBaseKey {
    ...
    public static String FIREBASE_COLLECTION_NAME="Devices";
    ...
    public static String FIREBASE_SleepQuality="SleepQuality";
    public static String FIREBASE_Stress="Stress";
    ...
    public static String AvgOxygen="AvgOxygen";
    public static String MaxOxygen="MaxOxygen";
